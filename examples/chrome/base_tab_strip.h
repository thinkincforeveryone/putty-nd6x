...
public:
    ...
    TabStripController* controller() const
    {
...
protected:
    ...
    bool attaching_dragged_tab() const
    {
        return attaching_dragged_tab_;
    }

    view::BoundsAnimator& bounds_animator()
    {
...
private:
    ...
    // See description above field for details.
    void set_attaching_dragged_tab(bool value)
    {
        attaching_dragged_tab_ = value;
    }
