...
public:
	...
	virtual view::View* GetView() const;
...
public:
    ...
    {
        return capturing_contents_;
    }
    void set_capturing_contents(bool cap)
    {
    ...
    base::TerminationStatus crashed_status() const
    {
        return crashed_status_;
    }
    int crashed_error_code() const
    {
    ...
    base::TimeTicks new_tab_start_time() const
    {
    ...
    bool closed_by_user_gesture() const
    {
        return closed_by_user_gesture_;
    }

    int content_restrictions() const
    {
