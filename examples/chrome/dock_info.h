...
public:
    ...
    void set_hot_spot(const gfx::Point& hot_spot)
    {
        hot_spot_ = hot_spot;
    }
    const gfx::Point& hot_spot() const
    {
        return hot_spot_;
    }
    ...
    const gfx::Rect& monitor_bounds() const
    {
    ...
    bool in_enable_area() const
    {
        return in_enable_area_;
    }
