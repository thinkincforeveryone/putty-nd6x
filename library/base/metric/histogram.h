...
public:
    ...
    {
        flags_ = static_cast<Flags> (flags_ | flags);
    }
    ...
    {
        return declared_min_;
    }
    Sample declared_max() const
    {
        return declared_max_;
    }
    virtual Sample ranges(size_t i) const;
    uint32 range_checksum() const
    {
        return range_checksum_;
    }
...
public:
    ...
    static bool dump_on_exit()
    {
        return dump_on_exit_;
    }

    static void set_dump_on_exit(bool enable)
    {
        dump_on_exit_ = enable;
    }
