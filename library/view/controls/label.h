...
public:
    ...
    RTLAlignmentMode rtl_alignment_mode() const
    {
    ...
    void set_collapse_when_hidden(bool value)
    {
        collapse_when_hidden_ = value;
    }
    bool collapse_when_hidden() const
    {
    ...
    bool paint_as_focused() const
    {
        return paint_as_focused_;
    }
