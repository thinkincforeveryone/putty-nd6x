...
public:
    ...
    void copy_normal_set_to_hot_set()
    {
        set_normal_set(hot_set_);
    }
...
protected:
    ...
    void set_normal_set(const BorderImageSet& set)
    {
        normal_set_ = set;
    }
    void set_hot_set(const BorderImageSet& set)
    {
        hot_set_ = set;
    }
    void set_pushed_set(const BorderImageSet& set)
    {
        pushed_set_ = set;
    }
...
public:
    ...
    void set_prefix_type(PrefixType type)
    {
        prefix_type_ = type;
    }
    ...
    bool show_multiple_icon_states() const
    {
        return show_multiple_icon_states_;
    }
