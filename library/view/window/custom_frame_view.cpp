      ...
      frame_(frame)
{
	...
	restore_button_->SetState(view::CustomButton::BS_DISABLED);
	...
	maximize_button_->SetState(view::CustomButton::BS_DISABLED);
	...
	minimize_button_->SetState(view::CustomButton::BS_DISABLED);
...
{
    restore_button_->SetState(CustomButton::BS_DISABLED);
    minimize_button_->SetState(CustomButton::BS_DISABLED);
    maximize_button_->SetState(CustomButton::BS_DISABLED);
